...
namespace CleanRefactor.Tests
{
    public sealed class ShopUseCasesTests
    {
            ...
            bool hasDoubleCoins = false)
        {
            ...
            FakePlayerRepository repository = new FakePlayerRepository(player);
        ...
        private sealed class FakePlayerRepository : IPlayerRepository
        {
            ...
            public FakePlayerRepository(Player i_player) => Player = i_player;
